...
def get_args():
    ...
    group.add_argument('--tokenizer-type', type=str, required=True,
                       choices=['BertWordPieceLowerCase','BertWordPieceCase',
                                'GPT2BPETokenizer', 'HFTokenizer', 'SentencePieceTokenizer', 'GPTSentencePieceTokenizer', 'NullTokenizer'],
    ...
    group.add_argument("--seq-length", type=int, default=1024, # use gpt2 default
                       help="Max length of the tokenizer.")
